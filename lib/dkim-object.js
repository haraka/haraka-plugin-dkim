...
class DKIMObject {
  ...
  // Promisified dns.resolveTxt with a timeout. dns.resolveTxt (not the
  // promises API) is kept so tests that mock it keep working. A timeout
  // rejects with a tagged error; a late DNS reply is ignored.
  #resolveTxt(lookup) {
